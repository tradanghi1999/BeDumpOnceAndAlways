        ...
        public int InsertQuestions(List<Question> questions)
        {
            ...
            foreach(Question question in questions)
            {
                ...
                cmd.CommandText = "exec InsertQuestion @myJSON = N'" + dAL_Question.QuestionContent + "'" +
                                                    ...
                                                    ", @myAnswer = N'" + dAL_Question.AnswerKey + "'" +
                                                    ", @myImageString = '" + dAL_Question.ImageBase64String + "'" +
                                                    ", @myImagePath = '" + dAL_Question.ImageRelativePath + "'";
                //cmd.CommandType = CommandType.StoredProcedure;
                //cmd.CommandText = "InsertQuestion";
                //cmd.Parameters.AddWithValue("@myJSON", "N'" + dAL_Question.QuestionContent + "'");
                //cmd.Parameters.AddWithValue("@myType", "N'" + dAL_Question.Type + "'");
                //cmd.Parameters.AddWithValue("@myAnswer", "N'" + dAL_Question.AnswerKey + "'");
                //cmd.Parameters.AddWithValue("@myImageString", "N'" + dAL_Question.ImageBase64String + "'");
